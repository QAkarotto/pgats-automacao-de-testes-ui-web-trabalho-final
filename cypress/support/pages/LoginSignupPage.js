class LoginSignupPage {
  elements = {
    ...
    signupErrorMessage: () => cy.get('.signup-form p').contains('Email Address already exist!'),
    ...
    loginErrorMessage: () => cy.get('.login-form p').contains('Your email or password is incorrect!')
  }
